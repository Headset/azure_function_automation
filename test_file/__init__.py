...
filename_1 = dir_path+r'\headset_weekly_flag_export.csv'
filename_2 = dir_path+r'\headset_weekly_unlink_export.csv'
...
try:
    response = sp.transmissions.send(
        ...
        html='Hey, This is a test!',
        from_email='analytics-monitor-test@headset.io',
        subject='Test File',
        attachments=[
            {
